...

{
  ...
  programs = {
    ...
    tmux = {
      ...
      escapeTime = 0;
      extraConfig = ''
        set-hook -g session-created 'rename-window history ; new-window ; rename-window profile ; new-window ; rename-window k8s ; new-window ; rename-window db ; new-window ; rename-window uno' ; new-window ; rename-window misc'
      '';
    };
